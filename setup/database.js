...
connection.query("CREATE TABLE IF NOT EXISTS users(email varchar(200), passwordhash varchar(2000));");
...
connection.query("INSERT INTO users(email, passwordhash) values('test@test.com', '" + passwordhash + "');");
